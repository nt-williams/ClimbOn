...
# TO DO: need a new make json function for boulders
        ...
        shinyMobile::f7Shadow(
          ...
          shinyMobile::f7Card(
            div(
              ...
              selectInput("climber", "Climber", 
                          c("Kat", "Nick")),
              selectInput("boulder_grade", "Grade", 
                          c("V0", "V1", "V2", "V3", "V4", "V5", "V6", 
                            "V7", "V8", "V9", "V10", "V11", "V12")), 
              selectInput("style", "Ascent style", 
                          c("Repetition", "Onsight", "Flash")), 
              conditionalPanel(condition = "input.style == 'Toprope'", 
                               selectInput("tries", "Number of attempts", 0:50)),
              selectInput("send", "Did you topout?", 
                          c("Yes", "No")), 
              shinyMobile::f7Button(
                inputId = "submit",
